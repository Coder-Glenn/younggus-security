...
//                .param("sort", "age,desc")
    ...
    public void whenCreateUserSuccess() throws Exception {
        ...
        String content = "{\"username\":\"glenn\",\"password\":null,\"birthday\": "+date.getTime()+"}";
    ...
    public void whenUpdateUserSuccess() throws Exception {
        ...
        System.out.println("date: " + date.getTime());
        String content = "{\"id\": 1,\"username\":\"glenn\",\"password\":null,\"birthday\": "+date.getTime()+"}";
    ...
    public void whenUploadSuccess() throws Exception {
        String result = mockMvc.perform(MockMvcRequestBuilders.fileUpload("/file")
                .file(new MockMultipartFile("files", "test.txt", "multipart/form-data", "hello upload".getBytes("UTF-8"))))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andReturn().getResponse().getContentAsString();
        System.out.println(result);
    }
