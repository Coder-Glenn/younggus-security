package cn.younggus.security.browser.authentication;

import cn.younggus.security.core.config.LoginType;
...
public class CustomerAuthenticationSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException, ServletException {
        ...
        if (LoginType.JSON.equals(securityProperties.getBrowserProperties().getLoginType())) {
            ...
            super.onAuthenticationSuccess(request, response, authentication); //跳转到原来的URL
        }
